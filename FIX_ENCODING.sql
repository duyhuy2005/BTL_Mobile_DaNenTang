-- =============================================
-- Script: Sửa lỗi encoding dữ liệu tiếng Việt
...
-- =============================================
-- INSERT LẠI GIAO HÀNG (chỉ 4 bản ghi, giữ lại #1)
-- =============================================
...
PRINT N'✅ Đã thêm lại 4 giao hàng với encoding đúng';

-- =============================================
-- INSERT LẠI HOÀN/ĐỔI TRẢ
-- =============================================

DECLARE @MaHoanDoiTra1 INT, @MaHoanDoiTra2 INT, @MaHoanDoiTra3 INT, @MaHoanDoiTra4 INT, @MaHoanDoiTra5 INT;
...
-- Yêu cầu 4: Trả hàng (Hoàn tất - cập nhật tồn kho)
INSERT INTO HoanDoiTra (MaHoaDon, MaKhachHang, LoaiYeuCau, LyDo, MoTaChiTiet, TrangThai, NgayYeuCau, NgayXuLy, SoTienHoan)
...
PRINT N'✅ Đã thêm lại 5 hoàn/đổi trả với encoding đúng';

-- Kiểm tra
SELECT COUNT(*) as TongGiaoHang FROM GiaoHang;
SELECT COUNT(*) as TongHoanDoiTra FROM HoanDoiTra;

PRINT N'✅ Hoàn tất sửa lỗi encoding!';
